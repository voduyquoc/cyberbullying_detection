...
def get_model_location(run_id):
    ...
    model_bucket = os.getenv('S3_BUCKET_NAME', 'mlops-zoomcamp-cyberbullying')
...
class ModelService:
    ...
    def prepare_features(self, tweet):
        features = {}
    ...
    def lambda_handler(self, event):
        ...
        for record in event['Records']:
            ...
            tweet_event = base64_decode(encoded_data)

            # print(tweet_event)
            tweet = tweet_event['tweet']
            tweet_id = tweet_event['tweet_id']

            features = self.prepare_features(tweet)
...
class KinesisCallback:
    ...
    def put_record(self, prediction_event):
        tweet_id = prediction_event['prediction']['tweet_id']
